...
import { level13 } from './arithProblems.js';
...
export default function ArithLevel13({
  ...
  const problemSet = level13; // imported problems for this level
