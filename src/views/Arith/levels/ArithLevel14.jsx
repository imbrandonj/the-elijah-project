...
import { level14 } from './arithProblems.js';
...
*/
export default function ArithLevel14({
  setLevelUpEvent,
  levelScore,
  setLevelScore,
}) {
  ...
  const problemSet = level14; // imported problems for this level
